...
public class SharedBufferTest
{
   public static void main( String[] args )
   {
      ...
      //Buffer sharedLocation = new SynchronizedBuffer(5);
      //Buffer sharedLocation = new LockBuffer();
      //Buffer sharedLocation = new LockBufferCircular(5);
      //Buffer sharedLocation = new ConditionBuffer();
      //Buffer sharedLocation = new SemaphoreBuffer();
      //Buffer sharedLocation = new SemaphoreBufferCircular(5);
      //Buffer sharedLocation = new ABQBuffer(5);
      //Buffer sharedLocation = new DoubleBuffer(5);
      //Buffer sharedLocation = new ExchangerBuffer(5);
      Buffer sharedLocation = new AtomicBuffer(5);
